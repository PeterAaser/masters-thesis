...
\end{figure}
%
\subsection{Core Reservoir Computer}
...
In order to get a feeling for what sort of parameters are available a small
sample is presented.
This is not an exhaustive list, it is just supposed to give an idea.

% Do not alter - voltages,
% Not really relevant - samplerate,

% Perturb parameters - max/min freq, stim sites,

% Reconfig parameters - individuals per generation, steps, mutation rate 
%                       choice of algorithm (could be backprop plus GA for instance)

% Here a description of the relevant parameters are described.
\cleardoublepage
