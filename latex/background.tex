...
%
Similarly, experiments using simulated artificial spin ice \cite{JENSEN_ASI}
shows that in a lattice of nano-magnets several underlying microstates map to the
same macro-state as shown in figure \ref{figJohASI}.
...
\begin{figure}[h]
  ...
  \caption{
    A simulated lattice of nanomagnets from \cite{JENSEN_ASI} allows us to peer
