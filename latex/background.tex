...
\begin{figure}[h!]
  \centering
  \subfloat[Microstate of a nanomagnetic lattice]{{\includegraphics[width=3.5cm]{fig/johannes_ASI_micro.png}}}%
  \quad
  \subfloat[The correspondence microstate color and magnet direction]{{\includegraphics[width=3.5cm]{fig/macroMicroLegend.png}}}%
  \quad
  \subfloat[Macrostate of a nanomagnetic lattice]{{\includegraphics[width=3.5cm]{fig/johannes_ASI_macro.png}}}%
  \caption[Simulated artificial spin ice]{
    A simulated lattice of nanomagnets. The color of each magnet in (a)
    corresponds to the direction of its magnetic field shown in (b).
    The corresponding macrostate for (a) is shown in (c).
  }
  \label{microMacro}%
\end{figure}
