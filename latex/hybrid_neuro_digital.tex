...
In order to get mad grant \$\$\$ we made a cyborg.
\blindtext
\section{Concept}
...
randomly.\par
As shown in fig \ref{figDopey} a neural culture evolves over time, showing an
increase in behavioral complexity.
TODO: should say something more about this.
\begin{figure}[h]
  \centering
