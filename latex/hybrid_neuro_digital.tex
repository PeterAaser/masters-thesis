...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{fig/rm/meame.jpg}
  \caption{Rough sketch.
    nice MEAME
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{fig/rm/SHODAN_interface.jpg}
  \caption{Rough sketch.
    Some wavez
  }
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{fig/rm/wf_transform.jpg}
  \caption{Rough sketch.
    Some wavez
  }
  \label{figWaves}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{fig/rm/lol_generics.jpg}
  \caption{Rough sketch.
  }
